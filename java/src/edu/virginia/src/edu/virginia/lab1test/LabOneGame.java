package edu.virginia.src.edu.virginia.lab1test;
 ...
 * */
public class LabOneGame extends edu.virginia.src.edu.virginia.engine.display.Game {

	/* Create a sprite object for our game. We'll use mario */
	edu.virginia.src.edu.virginia.engine.display.Sprite mario = new edu.virginia.src.edu.virginia.engine.display.Sprite("Mario", "Mario.png");
