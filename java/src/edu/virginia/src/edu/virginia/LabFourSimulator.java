package edu.virginia.src.edu.virginia;
 ...
 * */
public class LabFourSimulator extends edu.virginia.src.edu.virginia.engine.display.Game {

    /* Create a sprite object for our game. We'll use sun */
    edu.virginia.src.edu.virginia.engine.display.Sprite blank = new edu.virginia.src.edu.virginia.engine.display.Sprite("Screen", "blank.png");
    edu.virginia.src.edu.virginia.engine.display.Sprite sun = new edu.virginia.src.edu.virginia.engine.display.Sprite("Sun", "sun.png");
    /* Create the Sprites*/

    edu.virginia.src.edu.virginia.engine.display.Sprite planet = new edu.virginia.src.edu.virginia.engine.display.Sprite("Planet", "planet.png");
    edu.virginia.src.edu.virginia.engine.display.Sprite planet2 = new edu.virginia.src.edu.virginia.engine.display.Sprite("Planet2", "planet2.png");
    edu.virginia.src.edu.virginia.engine.display.Sprite moon2 = new edu.virginia.src.edu.virginia.engine.display.Sprite("Moon2", "moon2.png");
    edu.virginia.src.edu.virginia.engine.display.Sprite moon = new edu.virginia.src.edu.virginia.engine.display.Sprite("Moon1", "moon1.png"); //child of planet
