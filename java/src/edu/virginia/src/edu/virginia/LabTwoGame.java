 ...
 * */
public class LabTwoGame extends edu.virginia.src.edu.virginia.engine.display.Game {

    /* Create a sprite object for our game. We'll use mario */

    edu.virginia.src.edu.virginia.engine.display.AnimatedSprite mario = new edu.virginia.src.edu.virginia.engine.display.AnimatedSprite("Mario", "Mario.png", new Point(0,0));
    ...
    private void populateAnimations() {
        edu.virginia.src.edu.virginia.engine.display.Animation an = new edu.virginia.src.edu.virginia.engine.display.Animation("jump", 0, 10);
