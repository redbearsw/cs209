...
public class DisplayObjectContainer extends DisplayObject{
    ...
    private ArrayList<edu.virginia.engine.display.DisplayObjectContainer> children;
    ...
    public DisplayObjectContainer(String id) {
        ...
        this.setScaleY(1.0);
        this.setCount(30);
        this.children = new ArrayList<edu.virginia.engine.display.DisplayObjectContainer>();
    }
    ...
    public void addChild(edu.virginia.engine.display.DisplayObjectContainer obj) {
        this.children.add(obj);
        obj.setParent(this);
    }

    //addAtIndex
    public void addAtIndex(int i, edu.virginia.engine.display.DisplayObjectContainer obj) {
    ...
    public edu.virginia.engine.display.DisplayObjectContainer getChild(int index) {
        return this.children.get(index);
    }

    // Returns child given its id
    public edu.virginia.engine.display.DisplayObjectContainer getChildId(String id) {
    ...
    /* getter for children */
    public ArrayList<edu.virginia.engine.display.DisplayObjectContainer> getChildren() {
    ...
    public boolean collidesWith(edu.virginia.engine.display.DisplayObjectContainer other){
        int [] myHitbox;
        int [] otherHitbox;
        myHitbox = new int[4];
