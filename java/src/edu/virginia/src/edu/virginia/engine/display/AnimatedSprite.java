...
public class AnimatedSprite extends edu.virginia.src.edu.virginia.engine.display.Sprite {

    private ArrayList<edu.virginia.src.edu.virginia.engine.display.Animation> animations;
    ...
    private edu.virginia.src.edu.virginia.engine.util.GameClock gameClock;
    ...
    public AnimatedSprite(String id, String fn, Point pos) {
        ...
        this.animations = new ArrayList<edu.virginia.src.edu.virginia.engine.display.Animation>();
        this.playing = false;
        this.paused = false;
    ...
    public void initGameClock() {
        if (this.gameClock == null)
            this.gameClock = new edu.virginia.src.edu.virginia.engine.util.GameClock();
    }
    ...
    public edu.virginia.src.edu.virginia.engine.display.Animation getAnimation(String id){
        int i;
    ...
    public void setAnimations(edu.virginia.src.edu.virginia.engine.display.Animation an){
    ...
    private void animate(edu.virginia.src.edu.virginia.engine.display.Animation an){
